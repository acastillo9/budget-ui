...
<div class="w-full flex justify-center items-center">
	<div class="border p-4 rounded w-96 max-w-full">
		...
		<form class="flex flex-col gap-4 mb-4" method="post" use:enhance>
			{#if form?.error}
			...
			<div>
				...
				<div class="relative">
					<input
						...
						class="w-full rounded-md border border-neutral-300 bg-white p-3 pr-10 text-base font-normal text-gray-500 outline-none focus:border-sky-400 focus:shadow-md"
					/>
					<button
		...
		<a href="/login" class="text-blue-400 text-md hover:underline">Sign in</a>
	</div>
</div>
